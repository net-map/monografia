...
Os chamados sistemas de \textit{Ensemble Learning} são aqueles em que uma classificação é feita com base em diversos modelos treinados. Em tópicos anteriores foi discutido o uso do algoritmo AdaBoost, que é um método desse tipo para melhorar o poder de algoritmos "fracos" (i.e. \textit{Weak Learners}) treinando iterativamente diversos modelos fracos progressivamente. Porém, para agregar os modelos usados até agora, iremos implementar algo mais simples: sistemas de votação, ambos documentados a seguir.

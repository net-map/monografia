...
O \textit{back end} do net.map está hospedado numa instância em nuvem do \textit{Amazon AWS EC2}, gratuito para estudantes. Nesse servidor se encontram o banco de dados MongoDB, a API Rails e os \textit{scripts} de \textit{Machine Learning} escritos em R